...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tweenJs = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageLog = __webpack_require__(158);

	var _MessageLog2 = _interopRequireDefault(_MessageLog);

	var _MessageInput = __webpack_require__(172);
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					{ id: 'app-container' },
					_react2['default'].createElement(_MessageLog2['default'], null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesMessagesStore = __webpack_require__(159);

	var _storesMessagesStore2 = _interopRequireDefault(_storesMessagesStore);

	var MessageLog = (function (_React$Component) {
		_inherits(MessageLog, _React$Component);

		function MessageLog(props) {
			_classCallCheck(this, MessageLog);

			_get(Object.getPrototypeOf(MessageLog.prototype), 'constructor', this).call(this, props);
			...
			_storesMessagesStore2['default'].addListener(this.handleNewMessage.bind(this));
		}
		...
		_createClass(MessageLog, [{
			...
			value: function handleNewMessage() {
				this.setState({
					messages: _storesMessagesStore2['default'].getAll()
				});
			}
		}, {
			...
			value: function render() {
				...
				_storesMessagesStore2['default'].getAll().forEach(function (message) {
					var isSelf = message.user === _this.state.user;
					...
					messages.push(_react2['default'].createElement(
						'li',
						{ className: className, key: message.id },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fluxLibFluxStore = __webpack_require__(160);

	var _fluxLibFluxStore2 = _interopRequireDefault(_fluxLibFluxStore);

	var _dispatchDispatch = __webpack_require__(168);

	var _dispatchDispatch2 = _interopRequireDefault(_dispatchDispatch);

	var _dataMessages = __webpack_require__(171);

	var _dataMessages2 = _interopRequireDefault(_dataMessages);

	var MessagesStore = (function (_Store) {
		_inherits(MessagesStore, _Store);

		function MessagesStore() {
			_classCallCheck(this, MessagesStore);

			_get(Object.getPrototypeOf(MessagesStore.prototype), 'constructor', this).call(this, _dispatchDispatch2['default']);

			this._messages = _dataMessages2['default'];
		}
		...
		_createClass(MessagesStore, [{
			...
			value: function __onDispatch(payload) {
				...
				if (payload.actionType === 'message-create') {
					this._messages.push(payload.data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fbemitter = {
	  EventEmitter: __webpack_require__(162)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmitterSubscription = __webpack_require__(163);
	var EventSubscriptionVendor = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventSubscription = __webpack_require__(164);
...
/***/ function(module, exports) {
	...
	module.exports = [
		...
		{
			"user": "MikeX",
			"content": "Give me three minutes with him and I swear...  You want a story? Write this down.",
			"id": 1
		},
		{
			"user": "MikeX",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helperAutosizeTextarea = __webpack_require__(174);

	var _helperAutosizeTextarea2 = _interopRequireDefault(_helperAutosizeTextarea);
	...
	var MessageInput = (function (_React$Component) {
		...
		function MessageInput(options) {
			...
			_get(Object.getPrototypeOf(MessageInput.prototype), 'constructor', this).call(this, options);
			...
			this.toggleInputTween = new _tweenJs2['default'].Tween(this.tweenState);
		}
		...
		_createClass(MessageInput, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement('div', { className: 'centered', style: { bottom: this.state.buttonBottom },
						onClick: this.handleClick.bind(this), id: 'chat-button' }),
					_react2['default'].createElement('textarea', { className: 'centered', scrollTop: '10', onKeyUp: this.onKeyUp.bind(this),
			...
			value: function componentDidMount() {
				(0, _helperAutosizeTextarea2['default'])(_react2['default'].findDOMNode(this).querySelector('textarea'));
			}
		}, {
			key: 'onKeyUp',
			value: function onKeyUp(e) {
				if (e.which === ENTER_KEY) {
					...
					_dispatchDispatch2['default'].dispatch({
			...
			key: 'handleTween',
			value: function handleTween() {
				return this.setState(this.tweenState);
			}
		}, {
			key: 'hideTextarea',
			value: function hideTextarea() {
				this.toggleInputTween.to({ inputOpacity: 0, buttonBottom: 10 }, 300).easing(_tweenJs2['default'].Easing.Quartic.Out).onUpdate(this.handleTween.bind(this)).start();
			}
		}, {
			key: 'handleClick',
			value: function handleClick() {
				console.log(1111);
				this.toggleInputTween.to({ inputOpacity: 1, buttonBottom: -200 }, 300).easing(_tweenJs2['default'].Easing.Quartic.Out).onUpdate(this.handleTween.bind(this)).start();
			}
		}, {
			key: 'resizeTextarea',
	...
	function assign(ta) {
		...
		function init() {
			...
			if (style.boxSizing === 'content-box') {
				...
				heightOffset = parseFloat(style.borderTopWidth.replace('px', '')) + parseFloat(style.borderBottomWidth.replace('px', ''));
			}
